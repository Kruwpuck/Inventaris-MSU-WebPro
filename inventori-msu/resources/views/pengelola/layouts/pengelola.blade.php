  ...
  <nav class="navbar navbar-expand-lg fixed-top shadow-soft bg-white">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="{{ asset('aset/logo.png') }}" alt="Logo MSU" style="height: 45px" />
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navmenu">
        <ul class="navbar-nav mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pengelola.beranda') ? 'active' : '' }}"
              href="{{ route('pengelola.beranda') }}">Beranda</a>
          </li>

          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pengelola.laporan') ? 'active' : '' }}"
              href="{{ route('pengelola.laporan') }}">Laporan</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pengelola.approval') ? 'active' : '' }}"
              href="{{ route('pengelola.approval') }}">Approval</a>
          </li>
        </ul>
        ...
        <div class="ms-3 dropdown">
          <button class="btn btn-outline-secondary d-flex align-items-center rounded-pill px-3 py-1 border-0"
            ...
            <img src="{{ asset('aset/MSU.png') }}" alt="User" class="rounded-circle me-2" width="32" height="32" />
