<div>
  ...
  <section class="promo">
    <div class="container text-center position-relative">
      ...
      <a href="{{ asset('fe-guest/panduan_layanan.pdf') }}" target="_blank" class="btn btn-panduan mt-3 reveal-up"
      ...
      <div class="row g-4 flow-steps">
        ...
        <div class="col-6 col-lg-3">
          <div class="flow-card tap-anim reveal-up" style="transition-delay:.1s">
            ...
            <div class="flow-caption">Pengurus Melakukan Serah Terima</div>
          </div>
        </div>
      ...
      <div class="reveal-up">
        ...
        <div class="row g-3">
          ...
          <div class="col-12 d-flex align-items-end mt-3 gap-2">
            <div class="text-muted small js-daterange me-auto text-truncate" style="min-width: 0;">Silakan tentukan waktu peminjaman dulu.</div>
            <button id="btnShowCalendar" class="btn btn-success" type="button" title="Lihat Jadwal Harian" style="flex: 0 0 240px; white-space: nowrap;">
              <i class="bi bi-calendar3 me-1"></i> Cek Jadwal
            </button>
            <button id="btnSetDates" class="btn btn-success" style="flex: 0 0 240px; white-space: nowrap;">
    ...
    <div class="container">
      ...
      <div class="row g-4 align-items-stretch items-grid">
          ...
          <div class="col-6 col-md-4 col-lg-2-4">
            <article class="item-card tap-anim reveal-up h-100" data-type="barang" data-max="{{ $item->stock }}">
              ...
              <div class="item-thumb">
                <img src="{{ $imgSrc }}" alt="{{ $item->name }}" class="img-fluid"
        ...
        <div class="col-12 col-md-4 col-lg-2-4">
          <a href="{{ route('guest.catalogue.barang') }}"
            class="cta-card tap-anim reveal-up h-100 text-decoration-none">
  ...
  <section id="pinjam-fasilitas" class="py-4">
    <div class="container">
      ...
      <div class="row g-4 align-items-stretch items-grid">
        ...
        <!-- CTA Card -->
        <div class="col-12 col-md-4 col-lg-2-4">
          <a href="{{ route('guest.catalogue.ruangan') }}"
            class="cta-card tap-anim reveal-up h-100 text-decoration-none">
            <div class="cta-plus">+</div>
            <div>Cari Ruang</div>
          </a>
