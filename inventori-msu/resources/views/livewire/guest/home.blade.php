    ...
    <div class="container">
      <div class="reveal-up">
        ...
        <div class="row g-3">
          ...
          <div class="col-12 d-flex flex-wrap align-items-start justify-content-between mt-3 gap-2">
            <div class="text-muted small js-daterange mt-2">Silakan tentukan waktu peminjaman dulu.</div>
